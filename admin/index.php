        ...
        <div class="row clearfix">
                            ...
                            <div class="card bg-success text-center">
                                <div class="body">
                                    ...
                                    <h4 class="font-22 text-col-white mt-4">
                                        <small class="font-12 d-block mb-1"><i class="fa fa-caret-up"></i>
                                            15%</small>
                                        Lead
                        ...
                        <div class="carousel-item">
                            <div class="card bg-warning text-center">
                                <div class="body">
                                    ...
                                    <h4 class="font-22 text-col-white mt-4">
                                        <small class="font-12 d-block mb-1"><i class="fa fa-caret-up"></i> $95
                                            M</small>
                                        Ballance
            ...
            <div class="col-lg-5 col-md-12 col-sm-12">
                <div class="card overflowhidden">
                    ...
                    <div class="sparkline" data-type="bar" data-offset="90" data-width="97%" data-height="50px" data-bar-Width="10" data-bar-Spacing="10" data-bar-Color="#7cb5ec">
